...
/**
 * 
 * @ORM\Table(name="tablaamortizacionahorro")
 * @ORM\Entity(repositoryClass="Modulos\PersonasBundle\Entity\Repository\TablaAmortizacionAhorroRepository")
 */
class TablaAmortizacionAhorro
{   
    /**
     * @var integer
     *
