...
use Modulos\PersonasBundle\Entity\Pais;
use Modulos\PersonasBundle\Form\PaisType;
...
class PaisController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ModulosPersonasBundle:Pais')->findAll();

        return $this->render('ModulosPersonasBundle:Pais:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ModulosPersonasBundle:Pais:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ModulosPersonasBundle:Pais')->find($id);
        ...
        return $this->render('ModulosPersonasBundle:Pais:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ModulosPersonasBundle:Pais:edit.html.twig', array(
            'entity'      => $entity,
