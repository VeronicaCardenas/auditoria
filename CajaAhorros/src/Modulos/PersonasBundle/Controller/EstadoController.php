...
use Modulos\PersonasBundle\Entity\Estado;
use Modulos\PersonasBundle\Form\EstadoType;
...
class EstadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ModulosPersonasBundle:Estado')->findAll();

        return $this->render('ModulosPersonasBundle:Estado:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ModulosPersonasBundle:Estado:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ModulosPersonasBundle:Estado')->find($id);
        ...
        return $this->render('ModulosPersonasBundle:Estado:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ModulosPersonasBundle:Estado:edit.html.twig', array(
            'entity'      => $entity,
